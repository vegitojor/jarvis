...
public class ServicioColeccionImpl implements ServicioColeccion {
	...
	public List<Comic> buscarComic(Long id) {
		...
		Comic comic1 = new Comic(1L, "aaa", "1", null, 1L, null, "ab", "24", null, null, null);
		Comic comic2 = new Comic(2L, "baa", "2", null, 1L, null, "ab", "24", null, null, null);
		Comic comic3 = new Comic(3L, "caa", "3", null, 1L, null, "ab", "24", null, null, null);
		Comic comic4 = new Comic(4L, "daa", "1", null, 2L, null, "ab", "24", null, null, null);
		Comic comic5 = new Comic(5L, "eaa", "2", null, 2L, null, "ab", "24", null, null, null);
